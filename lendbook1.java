 ...
 * @author IamOP
 */
public class lendbook1 extends javax.swing.JFrame {
    ...
    public void Connect(){
        try {
            ...
            Logger.getLogger(lendbook1.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public void Lendbook_Load() //load the book in to the table from SQL
    {
        int c;
    ...
    public void Lendbook_Load1()
    {
        int c;
        
        try {
            pst = (PreparedStatement) con.prepareStatement("select * from lendbook");
            rs = pst.executeQuery();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Issue ID", "Member Name", "Book", "IssueDate", "RetrunDate"
            }
        ) {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            pst = (PreparedStatement) con.prepareStatement("delete from lendbook where id = ?");
            pst.setInt(1, id );
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String returndate = date_format1.format(txtrdate.getDate());
        try {
            pst = (PreparedStatement) con.prepareStatement("update lendbook set memberid = ?, bookname = ?, issuedate = ?, returndate = ? where id = ?");
            pst.setString(1,mid);
            ...
            if(k == 1)
            {
                JOptionPane.showMessageDialog(this, "Lendbook Updated");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            pst = (PreparedStatement) con.prepareStatement("insert into lendbook (id,memberid,membername,bookid,bookname,issuedate,returndate)values(?,?,?,?,?,?,?)");
            pst.setString(1,id);
            pst.setString(2,mid);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(lendbook1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
