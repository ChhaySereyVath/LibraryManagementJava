...
public class Category extends javax.swing.JFrame {
    ...
    public void Category_Load() //load the category in to the table from SQL
    {
        int c;
    ...
    private void initComponents() {
        ...
        txtstatus.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Instock", "Out of stock", " " }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            pst = (PreparedStatement) con.prepareStatement("insert into category(id,catname,status)values(?,?,?)");
            pst.setString(1,id);
