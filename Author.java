...
public class Author extends javax.swing.JFrame {
    ...
    public void Author_Load() //load the category in to the table from SQL
    {
        int c;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            pst = (PreparedStatement) con.prepareStatement("insert into author(id,name,address,phone)values(?,?,?,?)");
            pst.setString(1,id);
